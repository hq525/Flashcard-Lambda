...
> Historical baseline report. The findings below describe backend commit `725eb35a3832fdc36987bd853686709ee932bc03` and frontend commit `df024f5b3c33f4f02220b22e42e85a71b28f068f`, before security remediation. Source evidence links are pinned to those commits. See the [remediation record](security-remediation-2026-09-20.md) for implemented fixes and the [rollout record](security-rollout-2026-09-20.md) for deployment verification and its limits. The original probes assert insecure behavior and are restricted to the baseline checkout.
...
Evidence: [frontend config](https://github.com/hq525/flashcard-frontend/blob/df024f5b3c33f4f02220b22e42e85a71b28f068f/src/api/config.ts#L9), [request header](https://github.com/hq525/flashcard-frontend/blob/df024f5b3c33f4f02220b22e42e85a71b28f068f/src/api/client.ts#L30), [Amplify build](https://github.com/hq525/flashcard-frontend/blob/df024f5b3c33f4f02220b22e42e85a71b28f068f/amplify.yml#L12), [API Gateway auth](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/template.yaml#L23), and [router](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/httpapi/router.go#L62).
...
Evidence: [image request fields](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/models/request.go#L62), [record creation](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/persistence/repository.go#L59), [cascade deletion](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/service/cascade.go#L101), [S3 delete implementation](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/storage/s3.go#L54), and [legacy bucket permissions](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/template.yaml#L78).
...
Evidence: [presign validation](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/httpapi/presign.go#L23), [S3 signing](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/storage/s3.go#L36), [frontend size limit](https://github.com/hq525/flashcard-frontend/blob/df024f5b3c33f4f02220b22e42e85a71b28f068f/src/features/cards/CardCreateDialog.tsx#L24), [direct S3 upload](https://github.com/hq525/flashcard-frontend/blob/df024f5b3c33f4f02220b22e42e85a71b28f068f/src/api/resources.ts#L110), and [public bucket policy](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/template.yaml#L193).
...
Evidence: [server default](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/cmd/server/main.go#L15), [Makefile override](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/Makefile#L7), and [AWS wiring](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/app/app.go#L20).
...
- Image confidentiality — the template deliberately disables policy-level public blocking and grants anonymous `s3:GetObject` on all objects ([policy](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/template.yaml#L179)). Anyone holding an image URL can read it independently of future API authentication. This is a medium privacy risk if screenshots/notes are private; public media may be an intentional product decision. UUID keys reduce guessing, not access by a holder of the URL. Use a private bucket with authorized short-lived downloads or appropriately protected CloudFront delivery. A distribution with unrestricted public downloads would not make the images private. Heal needs the intended media-access policy and a migration decision.
- Resource limits — generic CRUD bodies lack the review route's explicit byte limit, and list/history queries collect all pages into memory ([handlers](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/httpapi/handlers.go#L66), [query loop](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/internal/persistence/store.go#L151)). Add body/field limits, bounded pagination, and request deadlines. AWS service limits provide some bounds; no memory-exhaustion exploit was demonstrated. The comments describing hard cost caps should also be corrected.
...
The build [uses the locally available Go compiler](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/Makefile#L3), while [go.mod](https://github.com/hq525/Flashcard-Lambda/blob/725eb35a3832fdc36987bd853686709ee932bc03/go.mod#L3) specifies only `go 1.26`. Update and pin the build toolchain to a current supported patch, rebuild, and rerun the scan; Go's [release feed](https://go.dev/dl/?mode=json) lists **1.26.8** for the existing release line at audit time. Raising the minimum/pinning the compiler is suitable for bounded remediation, with an explicit rebuild/deployment follow-up. The evidence JSON preserves advisory IDs and fixed-version data.
